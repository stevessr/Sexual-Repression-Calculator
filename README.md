...
本项目基于问卷设计学、心理测量学和用户体验研究的最佳实践，持续优化问卷质量：

### 最新优化（2024）
- **量表选项优化**: 更清晰、对称的Likert和频率量表选项
- **问题表述改进**: 简化复杂句式，减少双重否定，提高可读性
- **文化适应性**: 使用更中性、文化适当的表达
- **量表指导语**: 为每个量表添加清晰的填写指引
- **心理支持资源**: 在结果页面提供专业帮助渠道

详细信息请查看 [问卷优化文档](docs/questionnaire-optimization.md) 和 [实施总结](docs/questionnaire-optimization-summary.md)
...
- 在线咨询：[简单心理](https://www.jiandanxinli.com) | [壹心理](https://www.xinli001.com)
