...
export const KISS9_SHAME: Scale = {
  ...
  questions: [
    ...
    { id: 'ks_6', text: '我觉得自己在性方面存在某些缺陷', scale: 'kiss9_shame', type: 'likert', options: Object.values(FREQUENCY_OPTIONS), required: true },
    { id: 'ks_7', text: '我希望我能改变自己的性身份', scale: 'kiss9_shame', type: 'likert', options: Object.values(FREQUENCY_OPTIONS), required: true },
    { id: 'ks_8', text: '我觉得在性方面让重要的人失望了', scale: 'kiss9_shame', type: 'likert', options: Object.values(FREQUENCY_OPTIONS), required: true },
